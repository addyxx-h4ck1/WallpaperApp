const recentFunc = () => {
    ...
    shuffleArray(a);
      ...
      const parent = document.getElementById('recent-added')
  ...
  //
    ...
    //   button.className = 'load-more-rec'
    ...
    // let currentItem = 6;
    // const b = document.querySelectorAll('#recent-added img')
  
    // loadMore.onclick = () =>{
    //   let boxes = [...document.querySelectorAll('#recent-added img')];
