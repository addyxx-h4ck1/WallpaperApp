const eightkFunc = () => {
    fetch('database/eightk-collection.json')
    .then(res => {
      return res.json();
    })
    .then(res => {
    ...
    let a = res.eightkCollection;
  
    shuffleArray(a);
      /////////////////append data//////////////////////////
  
      const parent = document.getElementById('eightk')
  ...
  //////////////load more////////////
    let loadMore = document.querySelector('.load-more-8k');
    let currentItem = 6;
    const b = document.querySelectorAll('#eightk img')
  
    loadMore.onclick = () =>{
      let boxes = [...document.querySelectorAll('#eightk img')];
